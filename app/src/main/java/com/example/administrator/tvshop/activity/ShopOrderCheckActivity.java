...
public class ShopOrderCheckActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_order_check);
        initView();
    ...
    private void setFh() {
        ...
        URLEncode urlEncode = new URLEncode(AppUrl.setFH);
        urlEncode.add("id", id);
                ...
                try {
                    ...
                    switch (code) {
                        case UserConstants.LOGIN_SUCCESS:
                            Toast.makeText(ShopOrderCheckActivity.this, "发货成功", Toast.LENGTH_SHORT).show();
                            break;
                        default:
                            Toast.makeText(ShopOrderCheckActivity.this, json.getString("msg"), Toast.LENGTH_SHORT).show();
                            break;
                    }
